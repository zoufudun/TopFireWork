                ...
                <div className="fire-flame-panel" style={{ width: "280px", height: "160px", right: "16px", bottom: "-20px", overflow: "visible" }}>
                  <svg viewBox="0 0 100 140" style={{ width: "100%", height: "100%", overflow: "visible" }}>
                    <defs>
                      ...
                      <linearGradient id="flameOuterGradLoop" x1="0" y1="1" x2="0" y2="0">
                      ...
                      {/* Mid flame — orange */}
                      <linearGradient id="flameMainGradLoop" x1="0" y1="1" x2="0" y2="0">
                      ...
                      <linearGradient id="flameCoreGradLoop" x1="0" y1="1" x2="0" y2="0">
                        <stop offset="0%" stopColor="#ff9900" />
                        <stop offset="50%" stopColor="#ffee00" />
                        <stop offset="100%" stopColor="#ffffff" stopOpacity="0" />
                      </linearGradient>
                      {/* Inner tip — white hot */}
                      <linearGradient id="flameTipGradLoop" x1="0" y1="1" x2="0" y2="0">
                        <stop offset="0%" stopColor="#ffdd00" />
                        <stop offset="100%" stopColor="#ffffff" stopOpacity="0" />
                      </linearGradient>
                      <filter id="flameGlowLoop">
                    ...
                    <path d="M 50 130 C 5 130, -8 80, 30 28 C 34 52, 42 55, 46 28 C 50 8, 54 8, 58 28 C 62 55, 68 52, 72 28 C 105 80, 95 130, 50 130 Z"
                      fill="url(#flameOuterGradLoop)" filter="url(#flameGlowLoop)" className="svg-flame-outer" opacity="0.85" />
                    ...
                    <path d="M 50 130 C 18 130, 10 88, 38 38 C 41 56, 48 58, 50 38 C 52 58, 59 56, 62 38 C 90 88, 82 130, 50 130 Z"
                      fill="url(#flameMainGradLoop)" filter="url(#flameGlowLoop)" className="svg-flame-main" />

                    {/* Layer 3 — inner core */}
                    <path d="M 50 130 C 30 130, 26 96, 44 60 C 46 72, 50 74, 54 60 C 72 96, 68 130, 50 130 Z"
                      fill="url(#flameCoreGradLoop)" className="svg-flame-core" />

                    {/* Layer 4 — bright tip */}
                    <path d="M 50 130 C 38 130, 36 108, 46 80 C 48 88, 52 88, 54 80 C 62 108, 60 130, 50 130 Z"
                      fill="url(#flameTipGradLoop)" className="svg-flame-inner" />
